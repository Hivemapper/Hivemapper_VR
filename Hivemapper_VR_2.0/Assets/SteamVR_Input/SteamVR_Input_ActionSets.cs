...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Hivemapper p_Hivemapper;
        ...
        public static SteamVR_Input_ActionSet_Hivemapper Hivemapper
        {
            get
            {
                return SteamVR_Actions.p_Hivemapper.GetCopy<SteamVR_Input_ActionSet_Hivemapper>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Hivemapper = ((SteamVR_Input_ActionSet_Hivemapper)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Hivemapper>("/actions/Hivemapper")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Hivemapper};
        }
    }
}
