...
{
    //-------------------------------------------------------------------------
    public class TeleportInvisible : MonoBehaviour
    {
        public GameObject flightController; //To allow flight controller to control tooltips
        private bool showHint; 

        public SteamVR_Action_Boolean teleportAction = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("TeleportInvisible");
        ...
        //-------------------------------------------------
        private static TeleportInvisible _instance;
        public static TeleportInvisible instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = GameObject.FindObjectOfType<TeleportInvisible>();
                }
        ...
        void Start()
        {
            ...
            if (player == null)
            {
                Debug.LogError("<b>[SteamVR Interaction]</b> TeleportInvisible: No Player instance found in map.");
        ...
        void Update()
        {
            showHint = flightController.GetComponent<FlightControl>().showTooltips;//IsEligibleForTeleport(hand);
        ...
        private void UpdatePointer()
        {
            ...
            if (hitTeleportMarker != null) //Hit a teleport marker
            {
                ...
                if (showPlayAreaMarker)
                {
                    ...
                    TeleportAreaInvisible teleportArea = pointedAtTeleportMarker as TeleportAreaInvisible;
        ...
        private void TryTeleportPlayer()
        {
            if (visible && !teleporting)
            {
                if (pointedAtTeleportMarker != null && pointedAtTeleportMarker.locked == false)
                {
                    ...
                    //adjustment - want teleport hint to stay visible
                    //CancelTeleportHint();
                }
            }
        }
        ...
        private void InitiateTeleportFade()
        {
            ...
            if (teleportPoint != null && teleportPoint.teleportType == TeleportPoint.TeleportPointType.SwitchToNewScene)
            {
                ...
                TeleportInvisible.ChangeScene.Send(currentFadeTime);
            }
        ...
        private void TeleportPlayer()
        {
            ...
            TeleportInvisible.PlayerPre.Send(pointedAtTeleportMarker);
            ...
            if (teleportPoint != null)
            {
                ...
                //TeleportInvisible to a new scene
            ...
            TeleportAreaInvisible teleportArea = teleportingToMarker as TeleportAreaInvisible;
            if (teleportArea != null)
            {
                if (floorFixupMaximumTraceDistance > 0.0f)
                {
            ...
            TeleportInvisible.Player.Send(pointedAtTeleportMarker);
        }
                ...
                foreach (Hand hand in player.hands)
                {
                    ...
                    if (showHint)
                    {
                        ...
                        if (Time.time > prevHapticPulseTime + 0.05f)
                        {
                            ...
                            //Adjustment - removed haptic pulse
